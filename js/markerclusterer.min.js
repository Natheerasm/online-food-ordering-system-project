...
(MarkerClusterer.prototype.MARKER_CLUSTER_IMAGE_PATH_ =
  ...
  (MarkerClusterer.prototype.fitMapToMarkers = function () {
    for (
      var s, t = this.getMarkers(), e = new google.maps.LatLngBounds(), i = 0;
      (s = t[i]);
      i++
    )
  ...
  (MarkerClusterer.prototype.calculator_ = function (t, e) {
    for (var i = 0, s = t.length, n = s; 0 !== n; )
      (n = parseInt(n / 10, 10)), i++;
    return (i = Math.min(i, e)), { text: s, index: i };
  }),
  ...
  (MarkerClusterer.prototype.addMarkers = function (t, e) {
    if (t.length) for (var s, i = 0; (s = t[i]); i++) this.pushMarkerTo_(s);
  ...
  (MarkerClusterer.prototype.removeMarker_ = function (t) {
    ...
    if (this.markers_.indexOf) e = this.markers_.indexOf(t);
      ...
      for (var s, i = 0; (s = this.markers_[i]); i++)
        if (s == t) {
          e = i;
          break;
        }
  ...
  (MarkerClusterer.prototype.getExtendedBounds = function (t) {
    ...
    var a = e.fromDivPixelToLatLng(n),
      r = e.fromDivPixelToLatLng(o);
    return t.extend(a), t.extend(r), t;
  }),
  ...
  (MarkerClusterer.prototype.resetViewport = function (t) {
    for (var i, e = 0; (i = this.clusters_[e]); e++) i.remove();
    for (var s, e = 0; (s = this.markers_[e]); e++)
  ...
  (MarkerClusterer.prototype.repaint = function () {
    ...
    (this.clusters_.length = 0),
      ...
      window.setTimeout(function () {
        for (var i, e = 0; (i = t[e]); e++) i.remove();
      }, 0);
  }),
    ...
    var i = 6371,
      ...
      o =
        ...
        Math.cos((t.lat() * Math.PI) / 180) *
          ...
          Math.sin(n / 2) *
          Math.sin(n / 2),
      a = 2 * Math.atan2(Math.sqrt(o), Math.sqrt(1 - o)),
      r = i * a;
    return r;
  }),
  (MarkerClusterer.prototype.addToClosestCluster_ = function (t) {
    for (
      var o, e = 4e4, i = null, n = (t.getPosition(), 0);
      (o = this.clusters_[n]);
      n++
    ) {
      var a = o.getCenter();
    ...
    if (this.ready_)
      for (
        var s,
          ...
          e = this.getExtendedBounds(t),
          i = 0;
        (s = this.markers_[i]);
        i++
      )
        !s.isAdded &&
          this.isMarkerInBounds_(s, e) &&
  ...
  (Cluster.prototype.addMarker = function (t) {
    ...
    if (
      (n < this.minClusterSize_ &&
        t.getMap() != this.map_ &&
        t.setMap(this.map_),
      n == this.minClusterSize_)
    )
      for (var o = 0; n > o; o++) this.markers_[o].setMap(null);
  ...
  (Cluster.prototype.updateIcon = function () {
    ...
    if (e && t > e)
      for (var s, i = 0; (s = this.markers_[i]); i++) s.setMap(this.map_);
    else {
  ...
  (ClusterIcon.prototype.triggerClusterClick = function () {
    ...
    google.maps.event.trigger(t, "clusterclick", this.cluster_),
